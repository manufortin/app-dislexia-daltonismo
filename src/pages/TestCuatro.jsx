            ...
            <section class="text-gray-700 body-font border-t border-gray-200">
                <div class="container px-20 py-16 mx-auto">
                    ...
                    <div className='py-5 flex grid grid-cols-2 md:flex grid-cols-1'>
                        <div class="px-20">
                            <div class="max-w-screen-lg bg-white border border-gray-200 rounded-lg shadow-lg">
                                <img class="rounded-t-lg" src="/assets/img/pics/perro.png" alt="" />
                                <div class="p-5">
                                    <p class="mb-3 font-normal text-gray-700 text-center text-lg">¿Con qué letra <strong>empieza</strong> la palabra representada aquí?</p>
                                </div>
                            </div>
                        </div>
                        <div class="">
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 py-10">
                                <div class="grid gap-4">
                                    ...
                                    <div>
                                        <img class="h-auto max-w-full rounded-lg hover:scale-90 ease-in duration-300" src="/assets/img/letters/x.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="grid gap-4">
                                    <div>
                                ...
                                <div class="grid gap-4">
                                    <div>
                                        <img class="h-auto max-w-full rounded-lg hover:scale-90 ease-in duration-300" src="/assets/img/letters/j.jpg" alt="" />
                                    </div>
                                    <div>
                    ...
                    <div class="w-full bg-gray-200 rounded-full mt-16">
                        <div class="bg-green-600 text-xs font-bold text-green-100 text-center p-0.5 leading-none rounded-full" style={{ width: '83.33%' }}>83.33%</div>
                    </div>
                    <div className='mt-10'>
                        <a href='/testtres'>
