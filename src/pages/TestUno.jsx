        ...
        <Layout>
            <section class="text-gray-700 body-font border-t border-gray-200">
                <div class="container px-16 py-16 mx-auto">
                    <div>
                        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 md:text-sm lg:text-6xl text-left"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Test Dislexia Niños | 1</span><span class="bg-blue-100 text-blue-800 text-2xl font-semibold me-2 px-2.5 py-0.5 rounded ms-2">BETA</span></h1>
                        <p class="text-lg font-normal text-gray-500 lg:text-xl py-4 text-justify">
                            Diga el nombre de las siguientes letras, habilitando el microfono para ser escuchado y evaluado:</p>
                    </div>
                    <div class="">
                    ...
                    <div class="grid grid-cols-2 mt-5 md:grid-cols-4 gap-4">
                    ...
                    <div class="w-full bg-gray-200 rounded-full mt-16">
                        <div class="bg-green-600 text-xs font-bold text-green-100 text-center p-0.5 leading-none rounded-full" style={{ width: '33.33%' }}>33.33%</div>
                    </div>
                    <div className='py-10'>
                        <a href='/testdos'>
