            ...
            <Layout>
                <section class="text-gray-700 body-font border-t border-gray-200">
                    <div class="container px-20 py-16 mx-auto">
                        <div>
                            <h1 class="mb-4 text-3xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl text-left"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Test Dislexia Niños | 2</span><span class="bg-blue-100 text-blue-800 text-2xl font-semibold me-2 px-2.5 py-0.5 rounded ms-2">BETA</span></h1>
                            <p class="text-lg font-normal text-gray-500 lg:text-xl py-4 text-justify">
                                Lea las siguiente sílabas, debe apuntar su cursor sobre la carta para descubrir la lectura:</p>
                        </div>
                        <div class="">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="grid gap-4">
                                <div>
                                    <img class="h-auto max-w-full rounded-lg hover:scale-95 ease-in duration-300 blur hover:blur-none" src="/assets/img/cards/card1.png" alt="" />
                                </div>
                            </div>
                            <div class="grid gap-4">
                                <div>
                                    <img class="h-auto max-w-full rounded-lg hover:scale-95 ease-in duration-300 blur hover:blur-none" src="/assets/img/cards/card2.png" alt="" />
                                </div>
                            </div>
                            <div class="grid gap-4">
                                <div>
                                    <img class="h-auto max-w-full rounded-lg hover:scale-95 ease-in duration-300 blur hover:blur-none" src="/assets/img/cards/card3.png" alt="" />
                                </div>
                            </div>
                            <div class="grid gap-4">
                                <div>
                                    <img class="h-auto max-w-full rounded-lg hover:scale-95 ease-in duration-300 blur hover:blur-none" src="/assets/img/cards/card4.png" alt="" />
                                </div>
                            </div>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full mt-16">
                            <div class="bg-green-600 text-xs font-bold text-green-100 text-center p-0.5 leading-none rounded-full" style={{ width: '50%' }}>50%</div>
                        </div>
                        <div className='py-10'>
                            <a href='/testuno'>
